      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0; background-color: #9ABCC3; ">
              <a href=""  class="site_title"><i class="fa fa-paw"></i> <span style="color: black;">Gentellela Alela!</span></a>
            </div>
        ...
        <!-- top navigation -->
        <div class="top_nav">
          <div class="nav_menu" style="background-color: #9ABCC3;">
            <nav>
