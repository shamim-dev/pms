...
@endif
	...
	<h2 align="center" > <strong>Submit Task </strong> </h2>
	<div class="x_title">
	...
	<div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Seleect Task: <span class="required">*</span>
		 </label>
	...
	<div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">From Developer: <span class="required">*</span>
		</label>
		<div class="col-md-6 col-sm-6 col-xs-12">
